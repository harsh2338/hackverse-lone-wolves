...
class Eye():
    ...
    def is_left_wink(self,landmarks):
        ...
        if(left_len/left_ht>4):
            cv2.putText(self.frame, 'LEFT WINK', (50, 150), cv2.FONT_HERSHEY_COMPLEX, color=(0, 255, 0), thickness=3,
                    fontScale=3)
    ...
    def is_right_wink(self,landmarks):
        ...
        if(right_len/right_ht>4):
            cv2.putText(self.frame, 'RIGHT WINK', (50, 150), cv2.FONT_HERSHEY_COMPLEX, color=(0, 0, 255), thickness=3,
                    fontScale=3)
